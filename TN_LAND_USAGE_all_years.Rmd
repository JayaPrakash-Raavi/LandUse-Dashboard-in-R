...
# Load the CSV file
csv_data <- read_csv("./CSV_data/Forecasting_Result_2015_TDM.csv")
...
```{r}
b <- ggplot(data = merged_data) +
  geom_sf(aes(fill = HHINC), color = NA) +  # Remove borders by setting color = NA
  scale_fill_distiller(palette = "RdYlBu", direction = -1) +  # Diverging color scale from blue to red
...
ggplot(data = merged_data) +
  geom_sf(aes(fill = TOTEMP), color = NA) +  # Remove borders by setting color = NA
  scale_fill_distiller(direction = 1) +  # Sequential color scale, low values light, high values dark
...
ggplot(data = merged_data) +
  geom_sf(aes(fill = Res), color = NA) +  # Remove borders by setting color = NA
  scale_fill_distiller(direction = 1) +  # Sequential color scale, low values light, high values dark
  labs(title = "Residental Land Use",
       subtitle = "By Traffic Analysis Zone or MPO") +
  theme_minimal() +
  theme(legend.position = "bottom")
...
ggplot(data = merged_data) +
  geom_sf(aes(fill = Com), color = NA) +  # Remove borders by setting color = NA
  scale_fill_distiller(direction = 1) +  # Sequential color scale, low values light, high values dark
  labs(title = "Commercial Land Use",
       subtitle = "By Traffic Analysis Zone or MPO") +
  theme_minimal() +
  theme(legend.position = "bottom")
...
ggplot(data = merged_data) +
  geom_sf(aes(fill = Ind), color = NA) +  # Remove borders by setting color = NA
  scale_fill_distiller(direction = 1) +  # Sequential color scale, low values light, high values dark
  labs(title = "Industrial Land Use",
       subtitle = "By Traffic Analysis Zone or MPO") +
  theme_minimal() +
  theme(legend.position = "bottom")
...
ggplot(data = merged_data) +
  geom_sf(aes(fill = Agr), color = NA) +  # Remove borders by setting color = NA
  scale_fill_distiller(direction = 1) +  # Sequential color scale, low values light, high values dark
  labs(title = "Agricultural Land Use",
       subtitle = "By Traffic Analysis Zone or MPO") +
  theme_minimal() +
  theme(legend.position = "bottom")
